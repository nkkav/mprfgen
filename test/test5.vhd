-- File automatically generated by "mprfgen".
-- Filename: test5.vhd
-- Date: 24 October 2020 09:40:48 PM
-- Author: Nikolaos Kavvadias 2007-2020

library IEEE;
use IEEE.std_logic_1164.all;
use IEEE.numeric_std.all;
use WORK.util_functions_pkg.all;
...
begin
  ...
  nwp_nrp_bram_instance_2 : entity WORK.regfile_core(READ_FIRST)
    generic map (
      AW            => AW-log2c(NWP),
      DW            => DW
    )
  ...
  nwp_nrp_bram_instance_1 : entity WORK.regfile_core(READ_FIRST)
    generic map (
      AW            => AW-log2c(NWP),
      DW            => DW
    )
  ...
  nwp_nrp_bram_instance_3 : entity WORK.regfile_core(READ_FIRST)
    generic map (
      AW            => AW-log2c(NWP),
      DW            => DW
    )
  ...
  begin
    ...
    ia_sel_part := to_integer(unsigned(ia_sel(0)));
    case ia_sel_part is
  ...
  begin
    ...
    ia_sel_part := to_integer(unsigned(ia_sel(1)));
    case ia_sel_part is
